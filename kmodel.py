...
class KModel:
    ...
    def load_saved_model(self, model_name='simple_cnn', data_folder='data', data_name=None):
        ...
        # for new version of keras, it would not ask for compile any more?
    ...
    def predict_image(self, img_file, target_width=48, target_height=48, model=None, color_mode='grayscale'):
        '''
        '''
    ...
    def make_model(self, dataset, data_folder='data', data_name=None, model_name='simple_cnn', 
        ...
        #TODO: add loss function, optimizer
